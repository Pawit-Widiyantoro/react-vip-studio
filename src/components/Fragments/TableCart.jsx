...
const TableCart = ({products}) => {
    ...
    return(
        <table className={`text-left text-sm table-auto border-separate border-spacing-x-5 ${isDarkMode && "text-white"}`}>
        <thead>
            <tr>
                <th>Product</th>
                <th>Price</th>
        ...
        <tbody>
            ...
            <tr ref={totalpriceRef} className="font-bold">
                ...
                <td>$ {(total).toLocaleString('id-ID', {styles:'currency', currency:'USD'})}
                </td>
            </tr>
        </tbody>
    </table>
